        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Camera = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Chip = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ROM_RAM = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Connectivity = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 11, 19, 22, 7, 51, 57, DateTimeKind.Local).AddTicks(1926)),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
